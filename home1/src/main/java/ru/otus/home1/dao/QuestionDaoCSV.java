...
public class QuestionDaoCSV implements QuestionDao {
    ...
    public QuestionDaoCSV(Properties properties) throws IOException {
        String name = properties.getQuestions() + (properties.getLocale() == null ? "" : "_" + properties.getLocale().toString()) + ".csv";
